...
<head>
    ...
    <link href="{{ asset('dashboardasset/assets/css/loader.css') }}" rel="stylesheet" type="text/css" />
    <script src="{{ asset('dashboardasset/assets/js/loader.js') }}"></script>
    ...
    <link href="{{ asset('dashboardasset/plugins/apex/apexcharts.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dashboardasset/assets/css/dashboard/dash_1.css') }}" rel="stylesheet" type="text/css"
...
<body class="dashboard-analytics">
                    ...
                    <div class="dropdown  custom-dropdown-icon">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                src="{{ asset('dashboardasset/assets/img/ca.png') }}" class="flag-width"
                    ...
                    <div class="dropdown-menu position-absolute animated fadeInUp"
                        ...
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                <img src="{{ asset('dashboardasset/assets/img/90x90.jpg') }}" class="img-fluid mr-2"
                                    alt="avatar">
                                <div class="media-body">
                                    <h5>Alan Green</h5>
                                    <p>Project Leader</p>
    ...
    <script src="{{ asset('dashboardasset/plugins/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    ...
    <script src="{{ asset('dashboardasset/plugins/apex/apexcharts.min.js') }}"></script>
    <script src="{{ asset('dashboardasset/assets/js/dashboard/dash_1.js') }}"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    @yield('scripts')
</body>
